...
public class ConversationManagement
{
    ...
    public void startConversation(NPC npc)
    {
        ...
        //Introduction
        speechBoxManager.addSpeechBox(new SpeechBox(this.player.getName(), this.player.getSpeech("Introduction")));
        speechBoxManager.addSpeechBox(new SpeechBox(this.tempNPC.getName(), this.tempNPC.getSpeech("Introduction")));
    ...
    private void queryQuestionType()
    {
        ...
        if (buttons.size > 0) {
            speechBoxManager.addSpeechBox(new SpeechBox("What do you want to do?", buttons));
        } else {
            speechBoxManager.addSpeechBox(new SpeechBox("You need to find some clues before you question a suspect"));
            finishConversation();
        }
    }
    ...
    private void queryQuestionStyle()
    {
        ...
        speechBoxManager.addSpeechBox(new SpeechBox("How do you want to ask the question?", buttons));
    }
    ...
    private void queryWhichClue()
    {
        ...
        speechBoxManager.addSpeechBox(new SpeechBox("What clue do you want to ask about?", buttons));
    }
    ...
    private void accuseNPC()
    {
        if (this.tempNPC.isKiller()) {
            speechBoxManager.addSpeechBox(new SpeechBox("You found the killer well done"));
            finishConversation();
        } else {
            speechBoxManager.addSpeechBox(new SpeechBox("They are clearly not the killer, just look at them."));
            finishConversation();
        }
    }
    ...
    {
        speechBoxManager.removeCurrentSpeechBox();
